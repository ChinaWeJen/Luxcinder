...
public class LuxUIEvent
{
	...
	/// </summary>
	public readonly LuxUIContainer Target;

	public LuxUIEvent(LuxUIContainer target)
	{
		Target = target;
	}
}
...
public class LuxUIMouseEvent : LuxUIEvent
{
	...
	public LuxUIMouseEvent(LuxUIContainer target, Vector2 mousePosition)
		: base(target)
	{
...
public class LuxUIScrollWheelEvent : LuxUIMouseEvent
{
	...
	public LuxUIScrollWheelEvent(LuxUIContainer target, Vector2 mousePosition, int scrollWheelValue)
